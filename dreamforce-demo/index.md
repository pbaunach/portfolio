...
<section id="story-mapping" class="major-section major-section--design-a">
  <div class="major-section-inner">
    <div class="subsection">
      <h2>Story Mapping</h2>
      <figure class="case-study-screenshot">
        <img src="{{ '/assets/img/dreamforce-demo/asset 1.png' | relative_url }}" alt="Story mapping">
      </figure>
    </div>
  </div>
</section>

<section id="user-flow" class="major-section major-section--design-b">
  <div class="major-section-inner">
    <div class="subsection">
      <h2>User Flow</h2>
      <figure class="case-study-screenshot">
        <img src="{{ '/assets/img/dreamforce-demo/asset 2.png' | relative_url }}" alt="User flow">
      </figure>
    </div>
  </div>
</section>

<section id="mockups" class="major-section major-section--design-a">
  <div class="major-section-inner">
    <div class="subsection">
      <h2>Mockups</h2>
      <figure class="case-study-screenshot">
        <img src="{{ '/assets/img/dreamforce-demo/asset 3.png' | relative_url }}" alt="Mockups">
      </figure>
    </div>
  </div>
</section>

<section id="prototype" class="major-section major-section--design-b">
  <div class="major-section-inner">
    <div class="subsection">
      <h2>Prototype</h2>
      <figure class="case-study-screenshot">
