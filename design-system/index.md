  ...
  <div class="major-section-inner">
    <div class="subsection">
      ...
      <figure class="case-study-screenshot">
        <img src="{{ '/assets/img/design-system/atoms.png' | relative_url }}" alt="Design system atoms">
      </figure>
      <h3>Molecules</h3>
      <figure class="case-study-screenshot">
        <img src="{{ '/assets/img/design-system/molecules.png' | relative_url }}" alt="Design system molecules">
      </figure>
      <h3>Organisms</h3>
      <figure class="case-study-screenshot">
        <img src="{{ '/assets/img/design-system/organisms.png' | relative_url }}" alt="Design system organisms">
      </figure>
    </div>
  </div>
</section>

<section id="design-system-code" class="major-section major-section--design-b">
  <div class="major-section-inner">
    <div class="subsection">
...
<section id="design-system-in-action" class="major-section major-section--design-a">
  <div class="major-section-inner">
    <div class="subsection">
      <h2>Design System in Action</h2>
      <figure class="case-study-screenshot">
        <img src="{{ '/assets/img/design-system/Asset 2.png' | relative_url }}" alt="Design system in action 1">
      </figure>
      <figure class="case-study-screenshot">
        <img src="{{ '/assets/img/design-system/Asset 3.png' | relative_url }}" alt="Design system in action 2">
      </figure>
      <figure class="case-study-screenshot">
        <img src="{{ '/assets/img/design-system/Asset 4.png' | relative_url }}" alt="Design system in action 3">
      </figure>
    </div>
  </div>
</section>

<section id="design-project-framework" class="major-section major-section--design-b">
  <div class="major-section-inner">
    <div class="subsection">
      <h2>Design Project Framework</h2>
      <p>We developed a design process that kept us aligned on where we should be, and what deliverables were required at each step of the process.</p>
      <figure class="case-study-screenshot">
